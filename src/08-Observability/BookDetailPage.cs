...
/// <summary>
/// Page Object Model para a página de detalhes de um livro.
...
public class BookDetailPage
{
    ...
    {
        // Aguardar URL conter /book/
        await _page.WaitForURLAsync("**/book/**", new PageWaitForURLOptions
        {
            Timeout = 10000
        });
        
        // Aguardar o conteúdo da página de detalhes carregar
    ...
    /// <summary>
    /// Obtém todas as informações do livro como um objeto BookInfo.
    /// </summary>
